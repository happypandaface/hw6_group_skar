...
char in_comp_pyobj(pyobj a, pyobj b) {
	int i=0;
	struct array_struct *as = (struct array_struct*)&b.u;
	for(i=0;i<as->len;++i){
		if (equal_pyobj(a,as->data[i]))
			return 1;
	}
	return 0;
}
...
int main() {
{print_pyobj(bool_to_pyobj(({ double tmp0_0 = 6.7000000000000002; in_comp_pyobj(float_to_pyobj(tmp0_0), ({ pyobj list1_0 = make_list(4); ({ pyobj __0 = (*subscript_pyobj(list1_0, int_to_pyobj(0))=int_to_pyobj(8)); ({ pyobj __1 = (*subscript_pyobj(list1_0, int_to_pyobj(1))=int_to_pyobj(6)); ({ pyobj __2 = (*subscript_pyobj(list1_0, int_to_pyobj(2))=int_to_pyobj(7)); ({ pyobj __3 = (*subscript_pyobj(list1_0, int_to_pyobj(3))=float_to_pyobj(6.7000000000000002)); list1_0;});});});});}));})));printf("\n");}  return 0;
}
